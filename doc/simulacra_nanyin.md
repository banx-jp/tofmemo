...
## 4セット
* Purple Bambooを装備すると、クリティカルダメージが22%増加し、最終ダメージが28% / 32% / 36% / 40%増加します。
* このセット効果はオフハンドスロットで機能し、最高のスター評価を持つセットのみが効果を発揮します。
...
* 現在の武器が Purple Bamboo の場合、Dark Power は Purple Bamboo でのみホストでき、放浪者のダメージが9%増加します。
...
* 生成できるAbyssal Streamの最大数は3に増加します。
### ★6解放
