...
| 参 | 1500 | 開放時に一定確率で採取の報酬2倍 |
| 肆 | 2500 | 開放すると星辰碑探索の表示範囲を拡大できる |
| 伍 | 3500 | 最大HPを超大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
| 陸 | 4500 | 開放すると星辰碑に映される宝箱・玄武の表示範囲を拡大できる |
