...
| レベル | 動源・青龍 | 効果 |
| --- | --- | --- |
| 壱 | 0 | 開放すると最大HPを大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
| 弐 | 800 | 開放するとモンスター撃破EXPがアップ |
| 参 | 1200 | 開放時に一定確率で採取の報酬2倍 |
| 肆 | 1800 | 開放すると星辰碑探索の表示範囲を拡大できる |
| 伍 | 2600 | 最大HPを超大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
| 陸 | 3600 | 開放すると星辰碑に映される宝箱・玄武の表示範囲を拡大できる |
...
| 弐 | 600 | 開放すると最大HPを大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
| 参 | 900 | 動源採取器の週間上限+2 |
...
| --- | --- | --- |
| 壱 | 0 | 追加で物理攻撃力が大幅UP |
| 弐 | 800 | 開放すると最大HPを大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
...
| レベル | 動源・青龍 | 効果 |
| --- | --- | --- |
| 壱 | 0 | 開放すると、通常攻撃に大量の玄武ダメージを付与できる |
| 弐 | 600 | 開放すると最大HPを大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
| 参 | 900 | 通常攻撃の玄武ダメージを大幅UP |
| 肆 | 1400 | 流転域泉を開放すると報酬獲得 |
| 伍 | 2000 | 最大HPを大幅にUPできる(ほかの玄武神像の効果と重ね掛け可能) |
...
### 青龍神像おすすめ解放順（域幣重視）
* 青龍神像・尾Lv6：開放すると飼育代理店での売り値が30%UP
