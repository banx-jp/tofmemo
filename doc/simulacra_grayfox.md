...
### ★3
* 恩恵共鳴を発動し、威能ゲージを12層保持している状態でスキル「魔力変換」を発動すると自身と仲間の最終ダメージが25%増加、30秒持続
* この効果は重複しない
...
### ★5
* 自身の回復効果が15%増加
* 威能ゲージを12層消費するごとに、「免疫権限」を1層獲得し、致命的なダメージを1度だけ防ぐ
* 致命的なダメージを防いだあと、「免疫権限」を1層消費し、最大HPの15%を回復
* 最大4層まで重複可能
* 恩恵共鳴が発動している場合、「免疫権限」効果は周囲の仲間にも付与される
